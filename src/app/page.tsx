   ...
   return (
      <main>
         ...
         <div className="bg-black flex px-16 items-center justify-between py-6 w-full min-h-[10vh]">
          <div >
            <Image className="w-full" src={versace} alt="brandIcon" width={100} height={100}/>
          </div>
          <div>
            <Image src={zara} unoptimized alt="brandIcon" width={70} height={40}/>
          </div>
          <div>
            <Image src={gucci} alt="brandIcon" width={100} height={100}/>
          </div>
          <div>
            <Image src={prada} alt="brandIcon" width={100} height={100}/>
          </div>
          <div>
            <Image src={calvin} alt="brandIcon" width={100} height={100}/>
          </div>
         </div>
         <NewArrival/>
      </main>

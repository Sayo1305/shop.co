...
const Navbar  = (): React.JSX.Element => {
  ...
  return (
    ...
    <div className='w-full flex items-center justify-between sm:px-16 px-10 py-7'>
      <div onClick={()=>{router.push('/')}} className='text-3xl cursor-pointer try font-extrabold'>
            SHOP.CO
      </div>
      ...
      <div className='md:w-1/3 sm:w-1/2 sm:block hidden '>
            ...
            value={search}
            size='large' prefix={<SearchOutlined className='text-lg px-2'/>} placeholder='search for product' className='!bg-[#F0F0F0] text-lg sm:flex hidden w-full hover:!border-none !shadow-none hover:!shadow-none hover:!bg-[#F0F0F0] !border-none focus:!border-none outline-none !rounded-3xl p-2'/>
      </div>

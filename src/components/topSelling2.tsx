...
export const NewArrivalCard: React.FC<NewArrivalCardProps> = ({ product }) => {
      ...
      >
         ...
         <div className="text-sm w-full font_lato_custom px-2 my-5 font-medium">
            ...
            <div className="my-4 flex items-center justify-between font-semibold">
               ...
               <div className="flex items-center border border-black font-normal gap-2 text-white px-4 py-2 cursor-pointer rounded-md ">
                  <svg
